! function() {
    ...
    const c = function(e) {
        ...
        w = function(e) {
            ...
            if (t.forEach((e => {
                ...
                })), 0 !== n && n < parseInt(this.threshold)) throw new r(this)
        },
        v = function(e) {
            const t = e.getAll(this.field);
            let n = 0;
    ...
    function O(e) {
        ...
        e.wpcf7 = {
            ...
            t.detail.apiResponse.captcha && j(e, t.detail.apiResponse.captcha), t.detail.apiResponse.quiz && T(e, t.detail.apiResponse.quiz)
